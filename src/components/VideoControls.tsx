      ...
      <div className="absolute right-4 bottom-32 flex flex-col items-center space-y-6">
        ...
        <div className="flex flex-col items-center">
          <button
            ...
            className={`p-3 rounded-full transition-all duration-300 active:scale-95 touch-manipulation ${
        ...
        <div className="flex flex-col items-center">
          <button 
            ...
            className="p-3 rounded-full bg-black/50 text-white hover:bg-white/20 transition-all duration-300 active:scale-95 touch-manipulation"
          >
        ...
        {/* Share */}
        <div className="flex flex-col items-center">
          <button className="p-3 rounded-full bg-black/50 text-white hover:bg-white/20 transition-all duration-300 active:scale-95 touch-manipulation">
