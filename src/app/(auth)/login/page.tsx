...
export default function Login() {
  ...
  return (
    <div className="md:w-[400px] w-[90%] bg-[#1a1a1a] shadow-amber-600 shadow-2xs mx-auto p-6">
      <div className="py-4">
        <div className="font-bold text-gray-200 md:text-xl text-lg flex items-center justify-start">welcomeBack</div>
      ...
      <div className="mt-4 flex text-sm justify-center">
        <span className="pr-2 text-gray-300">no Account</span>
